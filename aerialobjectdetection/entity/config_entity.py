...
from aerialobjectdetection.constant.training_pipeline import *

@dataclass
class TrainingPipelineConfig:
    artifacts_dir: str = ARTIFACTS_DIR
    
traininig_pipeline_config: TrainingPipelineConfig = TrainingPipelineConfig()
...
class DataValidationConfig:
    data_validation_dir: str = os.path.join(
        traininig_pipeline_config.artifacts_dir, DATA_VALIDATION_DIR_NAME
    )
