...
from aerialobjectdetection.entity.config_entity import DataValidationConfig
...
class DataValidation:
    ...
    def initiate_data_validation(self) -> DataValidationArtifact:
        logging.info("Entered into data validation method of DataValidation class")
        try:
            status = self.validate_all_files_exist()
            data_validation_artifact = DataValidationArtifact(validation_status=status)
            
            logging.info("Exited initiate data validation method of DataValidation class")
            logging.info(f"Data Valiadtion artifact : {data_validation_artifact}")
